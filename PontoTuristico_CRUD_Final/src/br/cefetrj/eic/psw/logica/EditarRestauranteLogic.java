...
public class EditarRestauranteLogic implements Logica{

	private static String INSERIR_OU_ALTERAR = "/restaurante/Alterar.jsp";
	...
	public String executa(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			logger.info("Editar restaurante - ID: " + request.getParameter("id"));
