...
public class EditarUsuarioLogic implements Logica{

	private static String INSERIR_OU_ALTERAR = "/usuario/Alterar.jsp";
	...
	public String executa(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			logger.info("Editar Usuário - ID: " + request.getParameter("id"));
