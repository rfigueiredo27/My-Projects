	...
	<div class="contact-section">
		<div class="container">
			<div class="row">
				...
				<fmt:message key="idioma" />:<a href="mvc?logica=DetalhePontoTuristicoLogic&id=${alb.id}&&localidade=pt_BR"> PT-BR</a> &nbsp; | &nbsp; <a href="mvc?logica=DetalhePontoTuristicoLogic&id=${alb.id}&&localidade=en_US">EN-US</a>
				
				<form class="contact-form" method="post"
					action="<%=request.getContextPath()%>/mvc?logica=SalvarPontoTuristicoLogic" >
					...
					<div class="form-group">
						<fmt:message key="estado" />: <input type="text" readonly="readonly" name="estado" class="form-control"
							value="${alb.estado}" />
					</div>

					 <a class="btn btn-danger" href="mvc?logica=ListarPontoTuristicoLogic&localidade=${param.localidade}"><fmt:message key="voltar" /></a>
				</form>
			</div>
		</div>
	</div>
