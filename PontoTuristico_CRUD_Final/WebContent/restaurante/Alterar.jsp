	...
	<div class="contact-section">
		<div class="container">
			<div class="row">
				...
				<fmt:message key="idioma" />:<a href="mvc?logica=EditarRestauranteLogic&id=${alb.id}&&localidade=pt_BR"> PT-BR</a> &nbsp; | &nbsp; <a href="mvc?logica=EditarRestauranteLogic&id=${alb.id}&&localidade=en_US">EN-US</a>
